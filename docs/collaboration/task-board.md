...
| KNTT-MAP-001 | Chuẩn hóa mapping KNTT → 25 chuyên đề → skill | GEMINI_LEAD + CHATGPT_INTEGRATE | DONE |
...
| KNTT-MAP-G8-001 | Mapping Toán 8 KNTT → Vertical Spine/skill | GEMINI_LEAD + CHATGPT_INTEGRATE | DONE (PASS-WITH-CHANGES) |
| KNTT-MAP-G9-001 | Mapping Toán 9 KNTT → Vertical Spine/skill + audit | GEMINI_LEAD + CHATGPT_INTEGRATE | DONE (PASS-WITH-CHANGES) |
