# Core Readiness Check – Hàm số và đồ thị
...
<div data-readiness-check-v1="assets/data/assessment/10-ham-so-do-thi-core-v1.json"></div>
...
- **← Học:** [Hàm số và đồ thị](index.md)
- **← Luyện tập:** [Practice Room](bai-tap.md)
- **→ Học tiếp:** [11 – Căn thức và biến đổi căn thức](../11-can-thuc/index.md)
