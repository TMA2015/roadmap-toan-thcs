# Core Readiness Check – Biểu thức và biến đổi đại số
...
<div data-readiness-check-v1="assets/data/assessment/04-bieu-thuc-dai-so-core-v1.json"></div>
...
- **← Học:** [Biểu thức và biến đổi đại số](index.md)
- **← Luyện tập:** [Practice Room](bai-tap.md)
- **→ Học tiếp:** [05 – 7 Hằng đẳng thức đáng nhớ](../05-7-hang-dang-thuc/index.md)
