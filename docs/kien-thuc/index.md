...
!!! info "Trạng thái biên soạn"
    Các chuyên đề **02, 03, 04, 05, 06, 07, 08, 09, 10, 11, 12 và 13** đã có nội dung chi tiết. Các chuyên đề còn lại đã được tạo **khung chuẩn** để bảo đảm URL, menu và cấu trúc thống nhất trước khi biên soạn sâu.
...
- [20. Hình học tổng hợp, đo lường và hình khối](20-hinh-hoc-tong-hop/index.md)
- [21. Thống kê và thu thập dữ liệu](21-thong-ke/index.md)
- [22. Các đại lượng đặc trưng của dữ liệu](22-dai-luong-dac-trung/index.md)
