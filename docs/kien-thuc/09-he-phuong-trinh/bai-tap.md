...
??? example "Xem lời giải"
    (2+1=3) và (2cdot2-1=3), nên ((2;1)) là nghiệm hệ.
...
??? example "Xem lời giải"
    [
    2x=10Rightarrow x=5,quad y=4.
    ]

#### 09-WR-05 · Biến đổi trước khi giải
Giải hệ (rac{x}{2}+rac{y}{3}=2, x-y=1).
...
??? example "Xem lời giải"
    ...
    Từ (x=y+1):
    [
    3(y+1)+2y=12Rightarrow5y=9Rightarrow y=rac95,quad x=rac{14}{5}.
    ]
...
??? example "Xem lời giải"
    Thế:
    [
    2x+3x-1=9Rightarrow x=2,quad y=5.
    ]
...
??? example "Xem lời giải"
    [
    egin{cases}x+y=46\x-y=12end{cases}
    Rightarrow x=29, y=17.
    ]
...
Giải hệ (rac{x+y}{2}=3, rac{x-y}{3}=1).
