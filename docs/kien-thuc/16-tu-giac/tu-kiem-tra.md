# Core Readiness Check – Chuyên đề 16 – Tứ giác và các hình đặc biệt
...
<div data-readiness-check-v1="assets/data/assessment/16-tu-giac-core-v1.json"></div>
...
## Liên kết Roadmap
- **← Học:** [Chuyên đề 16 – Tứ giác và các hình đặc biệt](index.md)
- **← Luyện tập:** [Practice Room](bai-tap.md)
- **→ Học tiếp:** [17 – Thales và tam giác đồng dạng](../17-thales-dong-dang/index.md)
