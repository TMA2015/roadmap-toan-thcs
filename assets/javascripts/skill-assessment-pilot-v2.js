(() => {
  ...
  const BUILD = "learner-review-v2-20260926";
  ...
  const logic = Object.freeze({ KEY, BUILD, emptyState, normalizedState, appendEvidence, skillSummary, firstAttemptSummary, prepareItems, shuffle, isValidQuestion });
