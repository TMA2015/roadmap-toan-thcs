...
ok(index.includes("Luyện học thuật")&&index.includes("Bài toán kinh điển")&&index.includes("Phòng luyện ba đề hoàn chỉnh")&&index.includes("Kỹ năng thi — tách khỏi điểm học thuật"),"topic25 four lanes");
...
ok((mock.split("??? success")[0].match(/^### Bài [IVX]+/gm)||[]).length===5,"five-problem mock");
ok(mock.includes("120 phút")&&mock.includes("Không phải đề chính thức"),"mock scope and provenance");
ok(classic.includes("Viète")&&classic.includes("CLASSIC_GEO_001")&&classic.includes("CLASSIC_GEO_002")&&classic.includes("CLASSIC_INEQ_001"),"classic algebra/geometry archetypes");
